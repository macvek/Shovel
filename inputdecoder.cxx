...
static KeySequence sequences[] = {
    { .m = CTRL, .k = F1,          .seq = {0x1b, 0x5b, 0x31, 0x3b, 0x35, 0x50, 0xFF}}, 
    { .m = CTRL, .k = F2,          .seq = {0x1b, 0x5b, 0x31, 0x3b, 0x35, 0x51, 0xFF}},
    { .m = CTRL, .k = F3,          .seq = {0x1b, 0x5b, 0x31, 0x3b, 0x35, 0x52, 0xFF}},
    { .m = CTRL, .k = F4,          .seq = {0x1b, 0x5b, 0x31, 0x3b, 0x35, 0x53, 0xFF}},
    
    { .m = CTRL, .k = F5,          .seq = {0x1b, 0x5b, 0x31, 0x35, 0x3b, 0x35, 0x7e, 0xFF}},
    { .m = CTRL, .k = F6,          .seq = {0x1b, 0x5b, 0x31, 0x37, 0x3b, 0x35, 0x7e, 0xFF}},
    { .m = CTRL, .k = F7,          .seq = {0x1b, 0x5b, 0x31, 0x38, 0x3b, 0x35, 0x7e, 0xFF}},
    { .m = CTRL, .k = F8,          .seq = {0x1b, 0x5b, 0x31, 0x39, 0x3b, 0x35, 0x7e, 0xFF}},
    { .m = CTRL, .k = F9,          .seq = {0x1b, 0x5b, 0x32, 0x30, 0x3b, 0x35, 0x7e, 0xFF}},
    { .m = CTRL, .k = F10,         .seq = {0x1b, 0x5b, 0x32, 0x31, 0x3b, 0x35, 0x7e, 0xFF}},
    { .m = CTRL, .k = F11,         .seq = {0x1b, 0x5b, 0x32, 0x33, 0x3b, 0x35, 0x7e, 0xFF}},
    { .m = CTRL, .k = F12,         .seq = {0x1b, 0x5b, 0x32, 0x34, 0x3b, 0x35, 0x7e, 0xFF}},

    { .m = CTRL, .k = ARROW_UP,    .seq = {0x1b, 0x5b, 0x31, 0x3b, 0x35, 0x41, 0xFF}},
    { .m = CTRL, .k = ARROW_DOWN,  .seq = {0x1b, 0x5b, 0x31, 0x3b, 0x35, 0x42, 0xFF}},
    { .m = CTRL, .k = ARROW_RIGHT, .seq = {0x1b, 0x5b, 0x31, 0x3b, 0x35, 0x43, 0xFF}},
    { .m = CTRL, .k = ARROW_LEFT,  .seq = {0x1b, 0x5b, 0x31, 0x3b, 0x35, 0x44, 0xFF}},

    { .m = CTRL, .k = END,         .seq = {0x1b, 0x5b, 0x31, 0x3b, 0x35, 0x46, 0xFF}},
    { .m = CTRL, .k = HOME,        .seq = {0x1b, 0x5b, 0x31, 0x3b, 0x35, 0x48, 0xFF}},
    { .m = CTRL, .k = INSERT,      .seq = {0x1b, 0x5b, 0x32, 0x3b, 0x35, 0x7e, 0xFF}},
    { .m = CTRL, .k = DELETE,      .seq = {0x1b, 0x5b, 0x33, 0x3b, 0x35, 0x7e, 0xFF}},
    { .m = CTRL, .k = PAGEUP,      .seq = {0x1b, 0x5b, 0x35, 0x3b, 0x35, 0x7e, 0xFF}},
    { .m = CTRL, .k = PAGEDOWN,    .seq = {0x1b, 0x5b, 0x36, 0x3b, 0x35, 0x7e, 0xFF}},
